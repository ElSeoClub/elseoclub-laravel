<x-card title="Boleta parcial sede {{$location->name}}">
    <div class="grid grid-cols-12">
        ...
        <div class="col-span-8 pl-4 mb-3 pt-3">
            <x-input type="number" label="Emitidos" min="0" model="location.emitidos" defer="true"></x-input>
        </div>
        <div class="col-span-4 text-right pt-3 border-r pr-4 mb-3">
        ...
        <div class="col-span-8 pl-4 mb-3 pt-3">
            <x-input type="number" label="Si" min="0" model="location.si" defer="true"></x-input>
        </div>
        <div class="col-span-4 text-right pt-3 border-r pr-4 mb-3">
        ...
        <div class="col-span-8 pl-4 mb-3 pt-3">
            <x-input type="number" label="No" min="0" model="location.no" defer="true"></x-input>
        </div>
        <div class="col-span-4 text-right pt-3 border-r pr-4 mb-3">
        ...
        <div class="col-span-8 pl-4 mb-3 pt-3">
            <x-input type="number" label="Validos" min="0" model="location.validos" defer="true"></x-input>
        </div>
        <div class="col-span-4 text-right pt-3 border-r pr-4 mb-3">
        ...
        <div class="col-span-8 pl-4 mb-3 pt-3">
            <x-input type="number" label="Anulados" min="0" model="location.anulados" defer="true"></x-input>
        </div>
    </div>
    <x-slot name="footer">
