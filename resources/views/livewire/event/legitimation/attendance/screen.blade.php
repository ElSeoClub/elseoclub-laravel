        ...
        <div class="flex" style="height:calc(100vh - 310px)">
            <div class="w-3/4 flex p-3">
                ...
                <div class="w-2/3 ml-6">
                    <div class="w-full text-center text-xl mb-3">Lunes 7 de Noviembre de 2022<span id="clock"></span>
                    </div>
                    <x-card title="Datos del trabajador:">
                        <div class="-m-5 p-6" style="height:calc(100vh - 590px); overflow-y:hidden">
                            ...
                            @if ($user->posicion != null)
                            <div class="text-lg text-gray-900 font-bold mb-2"><span class="text-gray-600 "># en el
                                    padrón:</span> {{strtoupper($user->posicion)}}</div>
                            @endif
            ...
            <div class="w-1/4 pl-3 py-3">
                <x-card>
                    <img src="{{ asset('img/logocong.jpg') }}" />
                </x-card>
            </div>
        </div>
    </div>
