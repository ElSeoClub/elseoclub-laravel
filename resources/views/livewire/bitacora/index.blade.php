            ...
            <div class="flex gap-3 items-center p-3">
                ...
                <div class="bg-white shadow rounded w-full p-3">
                    <div class="flex gap-3 justify-between">
                        <div class="text-sm font-bold flex-grow truncate">
                            @if($mensaje->pin == 0)
                                <i class="fas fa-thumbtack text-gray-600 hover:text-red-600 cursor-pointer" wire:click="pin({{$mensaje->id}})"></i>
                            @else
                                <i class="fas fa-thumbtack text-red-600 hover:text-gray-600 cursor pointer" wire:click="unpin({{$mensaje->id}})"></i>
                            @endif
                            {{$mensaje->user->name}}
                        </div>
