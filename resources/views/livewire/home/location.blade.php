<div class="p-2">
    ...
    <div class="text-left">
        ...
        <p class="text-xl">Fecha de la votación: <span class="text-yellow-600 font-bold"></span>
        </p>
    ...
    <x-button icon="fas fa-download mt-5 py-3" color="red">Descargar convocatoria</x-button>
    @else
