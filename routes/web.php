...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/reportes/laboral/conciliacion-prejudicial-fecha', [ReportesController::class, 'conciliacionPrejudicialDate'])->name('reportes.conciliacion_prejudicial_date');
